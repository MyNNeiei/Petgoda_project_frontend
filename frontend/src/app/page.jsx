    ...
    <div className="min-h-screen">
      ...
      <div className="my-20">
        ...
        <div className="my-20 px-20">
          ...
          <div className="my-10">
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-[#2A1D16] dark:border-[#2A1D16]">
              <a href="#">
              ...
              <div class="p-5">
                ...
                <p class="mb-3 font-normal text-[#886551]">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
